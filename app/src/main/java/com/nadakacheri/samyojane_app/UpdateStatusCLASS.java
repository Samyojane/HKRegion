...
public class UpdateStatusCLASS {
    String GscNo, LoginID, DifferFromApplicant, CanbeIssued, Remarks, ReportNo, ReportDate, FatherName, MotherName,
            ...
            PlaceMatchWithRationCard, Photo, IMEI, VARIName, CST_Caste_Desc;
    ...
    List<ResidenceDetails> HKResidenceDetails = new ArrayList<>();
    ...
    public int getBinCom() {
        return BinCom;
    }

    public void setBinCom(int binCom) {
        BinCom = binCom;
    }

    public int getFatTitle() {
        return FatTitle;
    }

    public void setFatTitle(int fatTitle) {
        FatTitle = fatTitle;
    }
    ...
    public void setCasteSl(int casteSl) {
        CasteSl = casteSl;
    }
    ...
    public List<ResidenceDetails> getHKResidenceDetails() {
        return HKResidenceDetails;
    }

    public void setHKResidenceDetails(List<ResidenceDetails> HKResidenceDetails) {
        this.HKResidenceDetails = HKResidenceDetails;
    }

    public String getCST_Caste_Desc() {
        return CST_Caste_Desc;
    }

    public void setCST_Caste_Desc(String CST_Caste_Desc) {
        this.CST_Caste_Desc = CST_Caste_Desc;
    }
}

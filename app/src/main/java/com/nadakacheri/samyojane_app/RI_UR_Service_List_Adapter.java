        ...
        app_Name.setOnClickListener(v -> {
            ...
            if(applicant_Id!=null) {
                ...
                switch (serviceCode) {
                    ...
                    case "39":
                        if (Objects.equals(eng_certi, "E")) {
                            i = new Intent(context, RI_Field_Report_HK_Certificate.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        }
                        else {
                            i = new Intent(context, RI_Field_Report_HK_Certificate_Kan.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        }
                        i.putExtra("applicant_name", applicant_name);
                        i.putExtra("applicant_Id", applicant_Id);
                        i.putExtra("district_Code", district_Code);

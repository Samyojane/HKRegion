...
public class RI_UploadScreen extends AppCompatActivity {
    ...
    SQLiteOpenHelper openHelper, openHelperOne;
    SQLiteDatabase database, databaseOne;
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        try {
                            ...
                            FacilityCode = cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_btnDownload_ServiceTranTable.UPD_Service_Code));
                            ...
                            if(FacilityCode == 39)
                            {
                                details = getHKData(Applicant_Id);
                                updateStatusCLASS.setHKResidenceDetails(details);
                                Call<JsonObject> call = apiInterface_nic.UpdateHKStatus(updateStatusCLASS);
                                String finalApplicant_Id = Applicant_Id;
                                int finalFacilityCode = FacilityCode;
                                        ...
                                        if (response.isSuccessful()) {
                                            ...
                                            if (jsonObject1.isJsonNull()) {
                                                ...
                                                if (StatusCode.equals("1")) {
                                                    ...
                                                    if(finalFacilityCode == 39) {
                                                        databaseOne.execSQL("delete from " + DataBaseHelperClass_UploadResidence_Proofs.TABLE_NAME
                                                                + " where " + DataBaseHelperClass_UploadResidence_Proofs.GSCNO + "='" + finalApplicant_Id + "'");
    ...
    public List<ResidenceDetails> getHKData(String gscNo) {
        List<ResidenceDetails> details = new ArrayList<>();

        openHelperOne = new DataBaseHelperClass_UploadResidence_Proofs(RI_UploadScreen.this);
        databaseOne = openHelperOne.getWritableDatabase();

        Cursor cursor = databaseOne.rawQuery("select * from "
                + DataBaseHelperClass_UploadResidence_Proofs.TABLE_NAME_1 + " where "
        ...
        if (cursor.getCount() > 0) {
            ...
            if (cursor.moveToNext()) {
                do {
                    ...
                    Log.d("Loop_entering_here", "");
                    residenceData.setGSCno(cursor.getString( cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.GSCNo)));
                    residenceData.setDistrictCode(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKDistrict)));
                    residenceData.setTalukCode(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKTaluk)));
                    residenceData.setHobliCode(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKHobli)));
                    residenceData.setHabitationCode(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKVillage)));
                    residenceData.setTownCode(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKTown)));
                    residenceData.setWardCode(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKWard)));
                    residenceData.setResidingFrom(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_FromDate)));
                    residenceData.setResidingTo(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_ToDate)));
                    residenceData.setAddr1(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_Address)));
                    residenceData.setAddr2(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_Address1)));
                    residenceData.setAddr3(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_Address2)));
                    residenceData.setPincode(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_PinCode)));
                    residenceData.setProofFile(cursor.getString(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_File)));
                    residenceData.setAddrProofDoc(cursor.getInt(cursor.getColumnIndexOrThrow(DataBaseHelperClass_UploadResidence_Proofs.HKR_Document_Code)));

                    details.add(residenceData);
                } while (cursor.moveToNext());
            }
        }return details;
    }

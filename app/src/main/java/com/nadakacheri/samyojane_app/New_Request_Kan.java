...
public class New_Request_Kan extends AppCompatActivity{
    ...
    Button btnBack, btnSave, btnCancel, btnUploadProof, btndelete;
    ...
    TableRow Service6, Service67, Service678, trService10, Service10, trCatService9999, tr_casteService9999,
            trService55, trService551, trApplicantAge,  trFinYear, trCertValidity, trResiHobli, trResiVillage, trResiSubvillage, trResiWard, trResiTown;
    ...
    Button btnReport, btnDownDocs, btnViewDocs, btnUploadDocs, btnViewUploadDocs, btnAdd;
    ...
    String str;
    String lang_flag;
    String appImage=null,  finYear= null,certValidity =null,previousDate=null;;
    ImageView iv_scst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUploadProof = findViewById(R.id.btnUploadProofs);
...
//            }
        ...
        btnUploadProof.setOnClickListener(v -> {
            ...
            if (proofId ==0) {
                Toast.makeText(New_Request_Kan.this, " Please select the Document name for address proof", Toast.LENGTH_LONG).show();
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            if(getHKDistCode != 0)
            {
                if(getHKTalukCode !=0 )
                {
                    if( optionUR.equals("R"))
                    {
                        if(getHKHobliCode != 0)
                        {
                            if(getHKVillageCode != 0)
                            {
                                        ...
                                        if(!strAddress2.isEmpty())
                                        {
                                            if(!strPincode.isEmpty())
                                            {
                                                if(proofId !=0 )
                                                {
                                                    if(pdfInString != null)
                                                    {
                                                        DataBaseHelperClass_UploadResidence_Proofs openHelper = new DataBaseHelperClass_UploadResidence_Proofs(New_Request_Kan.this);
                                                    ...
                                                    {
                                                        Toast.makeText(New_Request_Kan.this, "Please capture the document", Toast.LENGTH_SHORT).show();
                                                    }
                                                }else
                                                {
                                                    Toast.makeText(New_Request_Kan.this, "Please select address proof name", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                            else
                                            {
                                ...
                                {
                                    Toast.makeText(New_Request_Kan.this, "Please select From date and To date", Toast.LENGTH_LONG).show();
                                }

                            }else{
                                Toast.makeText(New_Request_Kan.this, "Please select Village", Toast.LENGTH_LONG).show();
                            }

                        }
                        else{
                            Toast.makeText(New_Request_Kan.this, "Please select Hobli", Toast.LENGTH_LONG).show();
                        }
                                                    ...
                                                    if(pdfInString != null)
                                                    {
                                                        if(dateValidate && previouDateValidate) {
                                                            ...
                                                            if (Results == true) {
                                                                ...
                                                                sp_resi_dist.setSelection(0);
                                                                sp_resi_taluk.setSelection(0);
                                                                sp_resi_town.setSelection(0);
                                                                sp_resi_ward.setSelection(0);
                                                                fromDate = null;
                                                                toDate = null;
                                                                etStayingFrom.setText("");
                                                                etStayingTo.setText("");
                                                                ...
                                                                Toast.makeText(New_Request_Kan.this, "Couldn't save the data", Toast.LENGTH_LONG).show();
                                                                Log.d("Not Save in DB", "Not Saved in DataBase");
                                                            }
                                                        }else{
                                                            Toast.makeText(New_Request_Kan.this, "Date should be more than previous Date", Toast.LENGTH_LONG).show();
                                                        }
                                                    }else
                                                    {
                                                        Toast.makeText(New_Request_Kan.this, "Please capture the document", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(New_Request_Kan.this, "Please select Taluk", Toast.LENGTH_LONG).show();
                }

            }else
            {
                Toast.makeText(New_Request_Kan.this, "Please select District", Toast.LENGTH_LONG).show();
            }
        ...
        DatePickerDialog.OnDateSetListener fromdate =new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int day) {
                ...
                if(previousDate == null) {
                    previouDateValidate = true;
                    checkDateValidation(previousDate,etStayingFrom.getText().toString(), etStayingTo.getText().toString());
                }
                else checkDateWithPreviousValidation(previousDate,etStayingFrom.getText().toString());
            }
        };
        etStayingFrom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(New_Request_Kan.this, fromdate,FromCalendar.get(Calendar.YEAR),FromCalendar.get(Calendar.MONTH),FromCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        etStayingTo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(New_Request_Kan.this, todate,ToCalendar.get(Calendar.YEAR),ToCalendar.get(Calendar.MONTH),ToCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        myAdapter = new hk_residence_adapter(this,residenceList,new hk_residence_adapter.OnItemCheckListener() {
            ...
            public void onItemClick(ResidenceDetails itemToDelete) {
                openHelper = new DataBaseHelperClass_UploadResidence_Proofs(New_Request_Kan.this);
                database = openHelper.getWritableDatabase();
    ...
    public void checkDateValidation(String previousDate, String from, String to)
    {
            ...
            if(previousDate != null) {
                if (!from.isEmpty() && !to.isEmpty()) {
                    if (dfDate.parse(from).before(dfDate.parse(to))) {
                        ...
                        Toast.makeText(New_Request_Kan.this, "dates are correct", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(New_Request_Kan.this, "should be the same dates", Toast.LENGTH_LONG).show();

                    } else {
                        dateValidate = false; //If start date is after the end date
                        etStayingTo.setError("not proper");
                        Toast.makeText(New_Request_Kan.this, "not proper", Toast.LENGTH_LONG).show();
                    }
                }
            }else{
                Date date = dfDate.parse(from);
                if (date.after(dfDate.parse("01/01/2013")) && date.before(dfDate.parse("31/12/2013"))) {
                    dateValidate = true;
                    //ok everything is fine, date in range
                    Toast.makeText(New_Request_Kan.this, "valid input ", Toast.LENGTH_LONG).show();

                } else {
                    dateValidate = false;
                    Toast.makeText(New_Request_Kan.this, "Please select 1st date in the year 2013", Toast.LENGTH_LONG).show();
    ...
    public void checkDateWithPreviousValidation(String from, String to)
    {
        SimpleDateFormat dfDate  = new SimpleDateFormat("dd/MM/yyyy");
        try {
            if (!from.isEmpty() && !to.isEmpty()) {
    ...
    public void GetHKDistrict() {
        try {
            List<SpinnerObject> labels;
            sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(New_Request_Kan.this, 1);
            sqlLiteOpenHelper_class_kan.open_HKDistrict_Tbl();
            labels = sqlLiteOpenHelper_class_kan.Get_HKDistrict(getString(R.string.select_district_spinner));
            ArrayAdapter<SpinnerObject> dataAdapter = new ArrayAdapter<>(this, R.layout.spinner_item_color, labels);
            dataAdapter.setDropDownViewResource(R.layout.spinner_item_dropdown);
    ...
    public void GetHKTaluk(int DistCode) {
        try {
            List<SpinnerObject> labels;
            sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(New_Request_Kan.this, 1,2);
            sqlLiteOpenHelper_class_kan.open_HK_Taluk_Tbl();
            labels = sqlLiteOpenHelper_class_kan.Get_HKTaluk(getString(R.string.select_Taluk_spinner), DistCode);
            ArrayAdapter<SpinnerObject> dataAdapter = new ArrayAdapter<>(this, R.layout.spinner_item_color, labels);
            dataAdapter.setDropDownViewResource(R.layout.spinner_item_dropdown);
    ...
    public void GetHKHobli(int TalukCode) {
        try {
            List<SpinnerObject> labels;
            sqlLiteOpenHelper_class_kan = new SqlLiteOpenHelper_Class_Kan(New_Request_Kan.this, 1,2,3);
            sqlLiteOpenHelper_class_kan.open_HK_hobli_Tbl();
            labels = sqlLiteOpenHelper_class_kan.Get_HKHobli(getString(R.string.select_hobli), TalukCode);
            ArrayAdapter<SpinnerObject> dataAdapter = new ArrayAdapter<>(this, R.layout.spinner_item_color, labels);
            dataAdapter.setDropDownViewResource(R.layout.spinner_item_dropdown);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < count; i++) {
                            ...
                            // objects.add(new SpinnerObject(cursor.getString(cursor.getColumnIndex(CODE)), cursor.getString(cursor.getColumnIndex(LHM_Hobli_eName))));

                            //  labels.add(new SpinnerObject(object.getString()))
...
//                store = getString;
        ...
        {
            Toast.makeText(New_Request_Kan.this, "Image captured successfully", Toast.LENGTH_LONG).show();
